...
public class StudentCourseServiceTest  extends BaseIntegrationTest {
    ...
    private List<Course> getCourses() {
        ...
        courses.add(Course.builder().courseID("5").startDate(LocalDate.parse("2024-01-01")).completionEndDate(LocalDate.parse("2030-12-31")).courseCode("A").courseCategory(characteristicsLA).courseAllowableCredit(allowableCredits).courseLevel("11").build());
        courses.add(Course.builder().courseID("6").startDate(LocalDate.parse("2024-01-01")).completionEndDate(LocalDate.parse("2030-12-31")).courseCode("A").courseCategory(characteristicsLA).courseAllowableCredit(allowableCredits).build());
    ...
    private List<ExaminableCourse> getExaminableCourses() {
        ...
        examinableCourses.add(ExaminableCourse.builder().courseCode("B").courseLevel("10").examinableStart("1994-01").examinableEnd("2024-03").build());
