...
public class FetchGradStudentRecordSubscriberTest extends BaseIntegrationTest {
    ...
    @InjectMocks
    FetchGradStudentRecordSubscriber fetchSubscriber;
    ...
    public void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        Field connF = FetchGradStudentRecordSubscriber.class.getDeclaredField("natsConnection");
        connF.setAccessible(true);
        connF.set(fetchSubscriber, natsConnection.connection());
    }

    @Test
    public void test_OnMessage_Success() throws JsonProcessingException {
    ...
    public void test_GetTopicName() {
        assertThat(fetchSubscriber.getTopic())
                .isEqualTo(ca.bc.gov.educ.api.gradstudent.constant.Topics.GRAD_STUDENT_API_FETCH_GRAD_STUDENT_TOPIC.toString());
    }
