...
public class PermissionsConstants {
	...
	public static final String READ_GRAD_STUDENT_COURSE = PREFIX + "SCOPE_READ_GRAD_COURSE_DATA" + SUFFIX
			+ " and " + PREFIX + "SCOPE_READ_GRAD_STUDENT_COURSE_DATA" + SUFFIX;
	public static final String UPDATE_GRAD_STUDENT_COURSE = PREFIX + "SCOPE_READ_GRAD_COURSE_DATA" + SUFFIX
			+ " and " + PREFIX + "SCOPE_UPDATE_GRAD_STUDENT_COURSE_DATA" + SUFFIX;
	public static final String DELETE_GRAD_STUDENT_COURSE = PREFIX + "SCOPE_READ_GRAD_COURSE_DATA" + SUFFIX
			+ " and " + PREFIX + "SCOPE_DELETE_GRAD_STUDENT_COURSE_DATA" + SUFFIX;
}
