...
public enum StudentCourseValidationIssueTypeCode {
    ...
    STUDENT_COURSE_VALID("course", "Invalid Course ID - course does not exist in the ministry course registry" , ValidationIssueSeverityCode.ERROR),
    STUDENT_RELATED_COURSE_VALID("relatedCourse", "Invalid Course ID - course does not exist in the ministry course registry" , ValidationIssueSeverityCode.ERROR),
