...
public class ApiResponseModel<T> {
	...
	@Valid
	private List<ca.bc.gov.educ.api.gradstudent.util.ApiResponseMessage> messages = new ArrayList<ca.bc.gov.educ.api.gradstudent.util.ApiResponseMessage>();;
	...
	public void addMessageItem(String message, MessageTypeEnum status) {
		ca.bc.gov.educ.api.gradstudent.util.ApiResponseMessage responseMessage = new ca.bc.gov.educ.api.gradstudent.util.ApiResponseMessage(message, status);
		messages.add(responseMessage);
	}

	@Valid
	public List<ca.bc.gov.educ.api.gradstudent.util.ApiResponseMessage> getMessages() {
		return messages;
	}
