...
public interface PermissionsContants {
	...
	String UPDATE_GRADUATION_STUDENT_OPTIONAL_PROGRAM = _PREFIX + "UPDATE_GRAD_STUDENT_SPECIAL_DATA" + _SUFFIX;
	String READ_GRADUATION_STUDENT_OPTIONAL_PROGRAM = _PREFIX + "READ_GRAD_STUDENT_SPECIAL_DATA" + _SUFFIX;
	...
	String READ_GRAD_HISTORY_ACTIVITY = _PREFIX + "READ_GRAD_HISTORY_ACTIVITY_CODE_DATA" + _SUFFIX;
	...
	String STUDENT_ALGORITHM_DATA = _PREFIX + "READ_GRAD_GRADUATION_STATUS', 'READ_GRAD_STUDENT_DATA" + _SUFFIX;
}
