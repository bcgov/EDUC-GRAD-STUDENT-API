...
public class GraduationStudentRecordService {
    ...
    private List<UUID> getOptionalProgramIDForIncomingPrograms(DemographicStudent demStudent, List<OptionalProgramCode> optionalProgramCodes, String gradProgram) {
        ...
        log.info("Optional program code 1 is :: {}", demStudent.getProgramCode1());
        ...
        log.info("Optional program code 2 is :: {}", demStudent.getProgramCode2());
        ...
        log.info("Optional program code 3 is :: {}", demStudent.getProgramCode3());
        ...
        log.info("Optional program code 4 is :: {}", demStudent.getProgramCode4());
        ...
        log.info("Optional program code 5 is :: {}", demStudent.getProgramCode5());
