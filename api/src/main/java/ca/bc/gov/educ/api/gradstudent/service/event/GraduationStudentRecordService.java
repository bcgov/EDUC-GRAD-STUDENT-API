...
public class GraduationStudentRecordService {
    ...
    private StudentCourseEntity compareAndUpdateStudentCourseEntity(StudentCourseEntity newStudentCourseEntity, CourseStudentDetail courseStudent, CoregCoursesRecord coregCoursesRecord, GraduationStudentRecordEntity existingStudentRecordEntity) {
        ...
        var categoryCode = coregCoursesRecord.getCourseCategory() != null && coregCoursesRecord.getCourseCategory().getCode() != null ? coregCoursesRecord.getCourseCategory().getCode() : "";
        ...
        var isBA = "BA".equalsIgnoreCase(categoryCode);
        var isLD = "LD".equalsIgnoreCase(categoryCode);

        var fineArtsSkillsCode =
                StringUtils.isNotBlank(courseStudent.getCourseGraduationRequirement())
                        && isGrade11
                        && (
                        (is1996 && (isBA || isLD))       // 1996 + grade 11 + BA or LD
                                || (is2004_2018_2023 && isBA)      // 2004/2018/2023 + grade 11 + BA
                )
