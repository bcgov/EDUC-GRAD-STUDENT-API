-- STUDENT_COURSE_HISTORY definition

CREATE TABLE "STUDENT_COURSE_HISTORY"
(	"STUDENT_COURSE_HISTORY_ID" RAW(16) DEFAULT SYS_GUID(),
     "HISTORY_ACTIVITY_CODE" VARCHAR2(15) NOT NULL ENABLE,
     "STUDENT_COURSE_ID" RAW(16) NOT NULL ENABLE,
     ...
     CONSTRAINT "STUDENT_COURSE_HISTORY_PK" PRIMARY KEY ("STUDENT_COURSE_HISTORY_ID")
         USING INDEX TABLESPACE "API_GRAD_IDX"  ENABLE,
     CONSTRAINT "STUDENT_COURSE_HISTORY_HSTRY_ACTVTYCD_FK" FOREIGN KEY ("HISTORY_ACTIVITY_CODE")
     	  REFERENCES "HISTORY_ACTIVITY_CODE" ("HISTORY_ACTIVITY_CODE") ENABLE,
     CONSTRAINT "STUDENT_COURSE_HISTORY_EQUIV_OR_CHLNGCD_FK" FOREIGN KEY ("EQUIVALENT_OR_CHALLENGE_CODE")
         REFERENCES "EQUIVALENT_OR_CHALLENGE_CODE" ("EQUIVALENT_OR_CHALLENGE_CODE") ENABLE,
     CONSTRAINT "STUDENT_COURSE_HISTORY_FINE_ARTS_APPL_SKLSCD_FK" FOREIGN KEY ("FINE_ARTS_APPLIED_SKILLS_CODE")
         REFERENCES "FINE_ARTS_APPLIED_SKILLS_CODE" ("FINE_ARTS_APPLIED_SKILLS_CODE") ENABLE
) SEGMENT CREATION IMMEDIATE
 NOCOMPRESS LOGGING
  TABLESPACE "API_GRAD_DATA"   NO INMEMORY ;

CREATE INDEX IDX_COURSE_HISTORY_GRADUATION_STUDENT_RECORD_ID
    ON STUDENT_COURSE_HISTORY ("GRADUATION_STUDENT_RECORD_ID")
