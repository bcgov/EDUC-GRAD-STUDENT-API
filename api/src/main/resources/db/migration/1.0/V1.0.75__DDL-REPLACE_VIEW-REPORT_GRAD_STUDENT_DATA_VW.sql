...
SELECT
    ...
    JSON_VALUE(A1.STUDENT_GRAD_DATA, '$.school.localID' RETURNING VARCHAR2(128) DEFAULT 'error' ON ERROR) LOCAL_ID,
    JSON_VALUE(A1.STUDENT_GRAD_DATA, '$.school.dob' RETURNING VARCHAR2(128) DEFAULT 'error' ON ERROR) DOB,
