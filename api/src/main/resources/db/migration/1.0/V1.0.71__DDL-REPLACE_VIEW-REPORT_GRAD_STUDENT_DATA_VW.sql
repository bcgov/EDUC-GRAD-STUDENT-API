...
--     SUBSTR(A1.SCHOOL_AT_GRADUATION, 0, 3) DISTRICT_CODE_AT_GRAD,
    ...
    CASE
        WHEN JSON_VALUE(A1.STUDENT_GRAD_DATA, '$.school.districtId' RETURNING VARCHAR2(128) DEFAULT 'error' ON ERROR) <> 'error' THEN UPPER(REPLACE(JSON_VALUE(A1.STUDENT_GRAD_DATA, '$.school.districtId' RETURNING VARCHAR2(128)), '-',''))
        ELSE NULL
    END DISTRICT_ID,
