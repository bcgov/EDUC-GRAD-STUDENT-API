CREATE OR REPLACE VIEW REPORT_GRAD_STUDENT_DATA_VW AS
    ...
    WHERE
         (
            JSON_VALUE(A1.STUDENT_GRAD_DATA, '$.studentCertificatesTranscript.transcriptTypeCode' RETURNING VARCHAR2(16) DEFAULT '' ON ERROR) IS NOT NULL
            OR JSON_QUERY(A1.STUDENT_GRAD_DATA, '$.studentCertificatesTranscript.certificateTypeCodes') IS NOT NULL
         )
;
