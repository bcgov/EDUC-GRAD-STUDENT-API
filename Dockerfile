...
ENTRYPOINT ["java","-Duser.name=EDUC_GRAD_STUDENT_API","-Xms1300m","-Xmx1300m","-noverify",\
            ...
            "-XX:MaxMetaspaceSize=300m","-XX:ParallelGCThreads=1",\
            ...
            "ca.bc.gov.educ.api.gradstudent.EducGradStudentApiApplication"]
